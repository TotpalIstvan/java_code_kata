...
public class Exercise2Test extends ClassicOnlineStore {
    ...
    public void top3RichCustomer() {
         ...
         */
        Comparator<Integer> csokSor = ((o1, o2) -> o2 - o1);
        Stream<String> top3RichCustomerStream = customerList.stream().sorted((o1, o2) -> csokSor.compare(o1.getBudget(), o2.getBudget())).map(Customer::getName).limit(3);
